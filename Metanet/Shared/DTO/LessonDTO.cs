...
namespace Metanet.Shared.DTO
{
    public class LessonDTO
    {
        ...
        [Required(ErrorMessage = "Поле номер порядка обязательно для заполнения")]
        [Range(0, 100, ErrorMessage = "Значение поля номера порядка должно быть в промежутках от 0 до 100")]
